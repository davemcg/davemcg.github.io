...
Joy plots are partially overlapping density line plots that create the impression of a mountain range. They can be quite useful for visualizing substantial changes in distributions over time or space. 
