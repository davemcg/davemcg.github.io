...
I work for the National Eye Institute [NEI](https://nei.nih.gov), which allocates about $700 million dollars 
to fund eye research. They could spendt some of that money to build a web gene expression portal, right?

![http://www.eyeresearch.org/advocacy/adv_nih-nea-appr.html](/img/nei_funding.png)

Well, most of that money goes as grants to the extramural community (e.g. research labs
...
So, [eyeIntegration](https://eyeIntegration.nei.nih.gov/) is a essentially a 
