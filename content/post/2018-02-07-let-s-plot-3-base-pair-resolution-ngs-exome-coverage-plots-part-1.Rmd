---
title: 'Let’s Plot 3: Base pair resolution NGS (exome) coverage plots - Part 1'
author: David McGaughey
date: '2018-02-07'
slug: let-s-plot-3-base-pair-resolution-ngs-exome-coverage-plots-part-1
categories:
  - bioinformatics
  - Let’s Plot
  - R
...
## Curious?
If you want to see how I did the above, see [Part 2](/content/post/2018-02-08-let-s-plot-3-base-pair-resolution-ngs-exome-coverage-plots.html). This post also has some cooler plots. 
...
dd_class <- read_csv('~/git/Let_us_plot/003_coverage/dd_class.csv')
...
```{r, fig.width=10, fig.height=10, fig.keep = F}
dd_class %>% 
  ggplot(aes(x=Read_Depth, group=Name)) +
  facet_wrap(~Name) + 
  geom_density()
...
```{r, fig.width=6, fig.height=3, fig.keep = 'none'}
