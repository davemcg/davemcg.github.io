...
## Introduction
`bcftools view -r 1:40000-50000 vcf.gz` will output a tabix-indexed vcf containing the header and variants on chromosome 1 between coordinates 40,000 and 50,000 base pairs. 
